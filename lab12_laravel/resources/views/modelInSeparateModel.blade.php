...
@section('title') PassUsingViewData @endsection

@section('main_content')
    @if(session('result') === null)
        <div class="header-container">
            <p>ModelBindingInSeparateModel<p>
        </div>
        <form method="post" action="/Calc/ModelBindingInSeparateModel" class="calc-container">
            @csrf
